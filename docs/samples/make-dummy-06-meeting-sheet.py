...
# 用紙の割り付けは P9-c の会議の用紙（頭: 題＋会議名／日時のマス／場所／出席者・右上に押印欄。枠: 内容／決定事項・宿題／その他）。
import random
...
top = 42.4
b1 = box(0, top, 192, top + 142.2, "内容", (147, 169, 192), 21)
lines_body = [
    "【送迎ルート】",
...
top2 = top + 142.2 + 2.4
b2 = box(0, top2, 94.8, top2 + 56.4, "決定事項", (203, 180, 120), 8)
b3 = box(97.2, top2, 192, top2 + 56.4, "宿題", (195, 154, 138), 8)
